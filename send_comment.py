...
try:
    ...
    if "credentials" in error_message or "password" in error_message:
        print(f"\n{Fore.RED}Error: Invalid password! Please Double-Check Your Password.")
    elif "username" in error_message:
        print(f"\n{Fore.RED}Error: Entered username '{username}' is incorrect!")
    else:
        print(f"\n{Fore.RED}Error: {str(e)}")  # For any other unexpected errors
    sys.exit(1)
...
while True:
    try:
        ...
        print(f"{Fore.RED}Invalid Input, Please Enter A Valid Comment Count.")
...
while True:
    try:
        ...
        print(f"{Fore.RED}Invalid Input, Please Enter A Valid Delay Time (In seconds).")
...
while i <= int(cmtcount):
    try:
        ...
        print(f"\n{Fore.RED}Error while sending comment: {str(e)}")
        break
